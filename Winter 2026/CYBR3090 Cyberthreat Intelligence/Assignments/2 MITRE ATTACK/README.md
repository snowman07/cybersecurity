...
- [3 Mapping several adversaries (APT28, APT29, APT39) on MITRE ATT\&CK Navigator](#3-mapping-several-adversaries-apt28-apt29-apt39-on-mitre-attck-navigator)
  ...
  - [3.2 APT29 - create layer, set color coding, and insert scoring](#32-apt29---create-layer-set-color-coding-and-insert-scoring)
  - [3.3 APT39 - create layer, set color coding, and insert scoring](#33-apt39---create-layer-set-color-coding-and-insert-scoring)
  - [3.4 Combining all APT group into single layer](#34-combining-all-apt-group-into-single-layer)
...
### 3.2 APT29 - create layer, set color coding, and insert scoring

### 3.3 APT39 - create layer, set color coding, and insert scoring

### 3.4 Combining all APT group into single layer
Use case
